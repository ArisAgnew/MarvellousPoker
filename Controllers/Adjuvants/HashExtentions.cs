...
namespace MarvellousPoker.Controllers.Adjuvants
{
    internal static class HashExtentions
    {
        ...
        internal static int GetHashCode<TInitial, T1, T2, T3>(this TInitial initial, T1 arg1, T2 arg2, T3 arg3)
            where TInitial : notnull where T1 : notnull where T2 : notnull where T3 : notnull
            => unchecked(arg1.GetHashCode<T1>() +
                arg2.GetHashCode<T2>() +
                arg3.GetHashCode<T3>());

        internal static int GetHashCode<TInitial, T1, T2, T3, T4>(this TInitial initial, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
            where TInitial : notnull where T1 : notnull where T2 : notnull where T3 : notnull where T4 : notnull
            => unchecked(arg1.GetHashCode<T1>() +
                arg2.GetHashCode<T2>() +
                arg3.GetHashCode<T3>() +
                arg4.GetHashCode<T4>());
        ...
        internal static int GetHashCode<TInitial, T1, T2, T3, T4, T5>(this TInitial initial, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
            where TInitial : notnull where T1 : notnull where T2 : notnull where T3 : notnull where T4 : notnull where T5 : notnull
            => unchecked(arg1.GetHashCode<T1>() +
                arg2.GetHashCode<T2>() +
                arg3.GetHashCode<T3>() +
                arg4.GetHashCode<T4>() +
